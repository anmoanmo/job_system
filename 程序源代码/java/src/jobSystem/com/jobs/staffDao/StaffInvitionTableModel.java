...
public class StaffInvitionTableModel extends AbstractTableModel {
	...
	public StaffInvitionTableModel(int companyNumber) {
		staffs = staffDao.getPutStaffsList(companyNumber,1);
