...
public class PositionInvitionTableModel extends AbstractTableModel {
	CompanyDao companyDao = new CompanyDao();
	String[] columnNames = {"编号","公司名称","职位名称","联系人姓名","电话","招聘人数","学历要求","职称要求","薪资","公司地址","邀请人数"};
	ArrayList<Position> positions = null;
	Object[][] rowData = null;
	
	public PositionInvitionTableModel(String companyId) {
		positions = companyDao.getPositionSumMessageList(companyId,1);
